  ...
  return (
    <div style={{ width: "100vw", height: "100dvh", backgroundColor: "#000000" }}>
      ...
      >
        ...
        <Panel position="bottom-right" className="flex flex-col items-end gap-3 mb-4 mr-4 sm:mb-6 sm:mr-6">
          <ResetViewButton />
          <div className="text-white/40 text-xs tracking-widest font-medium pointer-events-none pr-1">
            Bala...
          </div>
        </Panel>
      </ReactFlow>
